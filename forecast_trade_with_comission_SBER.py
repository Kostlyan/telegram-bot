...
#df_main = read_csv('Sber_Forecast_Test.csv')
...
deals.to_csv('deals_sber.csv')
df2.to_csv('Sber_Forecast_Test.csv')
now = datetime.datetime.now()
#df2.to_csv('/opt/python/archive/Sber_Forecast_Test'+str(now.year)+str(now.month)+str(now.day)+str(now.hour)+str(now.minute)+str(now.second)+'.csv')
